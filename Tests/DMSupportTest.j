...
@implementation DMSupportTest : OJTestCase

- (void)testCPStringunderscoreString
{
    [self assert:@"movies" equals:[[CPString stringWithString:@"Movies"] underscoreString]];
    [self assert:@"movie_titles" equals:[[CPString stringWithString:@"MovieTitles"] underscoreString]];
    [self assert:@"movie_titles" equals:[[CPString stringWithString:@"movie_titles"] underscoreString]];
    [self assert:@"happy_birth_day" equals:[[CPString stringWithString:@"HappyBirthDay"] underscoreString]];
}
